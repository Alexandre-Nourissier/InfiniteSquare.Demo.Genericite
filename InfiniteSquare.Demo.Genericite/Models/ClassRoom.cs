...
namespace InfiniteSquare.Demo.Genericite.Models
{
    ...
    {
        public List<CustomEnumerable> Students { get; set; }

        /// <summary>
        /// Implement GetEnumerator(), allowing the use of foreach on an instance of SchoolYear to Enumerate through Students
        /// </summary>
        ...
        {
            return new CustomEnumerator<CustomEnumerable>(Students);
        }
    }
}